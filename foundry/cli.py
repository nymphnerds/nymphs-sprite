...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--no-postprocess", action="store_true", help="Save raw Z-Image outputs as final direction PNGs, skipping background removal, crop, normalize, and pixelation")
